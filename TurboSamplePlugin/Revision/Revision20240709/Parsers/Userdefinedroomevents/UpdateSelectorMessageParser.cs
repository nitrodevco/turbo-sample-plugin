...
internal class UpdateSelectorMessageParser : IParser
{
    public IMessageEvent Parse(IClientPacket packet)
    {
        ...
        var resolveFilterField = packet.PopBoolean();
        var resolveInverseField = packet.PopBoolean();
        ...
        return new UpdateSelectorMessage
        {
            Id = id,
            IntParams = intParams,
            ...
            StuffIds = stuffIds,
            ResolveFilterField = resolveFilterField,
            ResolveInverseField = resolveInverseField,
